---
title: LangSmithで5つのLLMを比較！トレーシング・エラーハンドリング完全ガイド【牡丹プロジェクト技術解説 Phase 1】
tags:
  - Python
  - AI
  - observability
...
本記事は、**AI VTuber三姉妹(Kasho、牡丹、ユリ)の記憶製造機システム**の技術解説シリーズ第1弾です。

## プロジェクト概要

「牡丹プロジェクト」は、**過去の記憶を持つAI VTuber** を実現するプロジェクトです。三姉妹それぞれが固有の記憶・個性・価値観を持ち、複数のLLMプロバイダーを使い分けながら配信を行います。
