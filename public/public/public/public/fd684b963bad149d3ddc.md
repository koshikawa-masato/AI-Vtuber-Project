---
title: GPT-4oとGeminiで画像理解AI実装！LangSmithトレーシング付きVLMガイド【牡丹プロジェクト技術解説 Phase 2】
tags:
  - Python
  - AI
  - Gemini
  ...
  - vlm
private: false
updated_at: '2025-11-05T13:06:40+09:00'
...
本記事は、**AI VTuber三姉妹(Kasho、牡丹、ユリ)の記憶製造機システム**の技術解説シリーズ第2弾です。

## プロジェクト概要

「牡丹プロジェクト」は、**過去の記憶を持つAI VTuber**を実現するプロジェクトです。三姉妹それぞれが固有の記憶・個性・価値観を持ち、配信中に**画像を理解して反応する**VLM機能を実装しました。
