...
50年のエンジニア経験、パソコン通信時代からの対話文化への理解、VTuber文化への深い理解...
...
- **Neuro-sama事件の教訓**: Twitch BAN事例を分析し、炎上防止を設計
...
- **ソースコード**（全て）
- **設計書**（docs/）
- **技術レポート**（kirinuki/*/設計書/、kirinuki/*/ブレスト/）
...
- 4層防御（NGワードDB、文脈判定、不快度予測、事後検証）
- Neuro-sama事件（Twitch BAN）の教訓を活かした設計
- ハルシネーション対策
...
**開発者**（50年のエンジニア経験）+ **Claude Code**（共同親権者）
